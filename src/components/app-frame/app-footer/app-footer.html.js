...
export function html() {
    return (
        <footer className={`app-footer-main py-3 px-3 ${this.props.className}`} style={{background: 'white'}}>
            <div className="container">
                {/* <div className="row flex-row justify-content-between"> */}
                <div className="d-flex justify-content-center align-items-center">
                    <p style={{color: '#6654C3', fontSize: 'var(--font-medium)', margin: '0', fontWeight: '500', padding: '4px 0'}}>Copyright © 2023 BenePay Ltd. All rights reserved</p>
