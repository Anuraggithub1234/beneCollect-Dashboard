...
export default class AgeingBar extends Component {
    ...
    constructor(props) {
        ...
        // i just comment it down for cheking what we need to do whle changing the verson of react to 18//
        this.bars;
        this.counts;
        this.dots;
        this.legends;
    ...
    prepareData = (values) => {
        ...
        let barColors = this.showCircle ? this.colors : this.colors.reverse();
            ...
            if (item.value > 0) {
                ...
                if (!this.showCircle) {
                    ...
                    if (itemCount == i) {
                        ...
                        styles.padding = "27px 10px 0px 10px"
                        styles1.padding = "10px 45px 0px 0px"
                    } else {
                        styles.textAlign = "center"
                        styles1.textAlign = "center"
                        styles.padding = "27px 0px 0px 22px"
                        styles1.padding = "10px 0px 0px 37px"
                    }
