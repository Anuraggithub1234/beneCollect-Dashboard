...
import { updatePassword ,signIn  ,signOut} from '@aws-amplify/auth';
...
class ChangePasswordForm extends Component {
  ...
  ValidatePassword = async () => {
    ...
    try {
      ...
      try {
        const user = await signIn(currentAuthenticatedUser, this.state.currentPassword);
  ...
  changePassword = async () => {
    try {
      ...
      const response = await updatePassword( this.state.currentPassword, newPassword);
