            ...
            <Grid container>
              <Grid item xs={12}>
                ...
                <Box
                  ...
                  marginTop="-55px"
                >
                  <Button variant="outlined" onClick={() => { this.navigateToNewPayment(); }}>+ Create New</Button>
                </Box>
              </Grid>
            </Grid>
                  ...
                  <div className="tab-content" id="pills-tabContent">
                    ...
                    >
                        ...
                        <Grid item xs={3} md={7}>
                            ...
                            <Grid item xs={3} md={8}>
                              <Grid container>
                                <Grid item xs={12} md={5}>
                                  <DatePicker style={{ width: '100%' }} selected={receiptStartDate} placeholderText={DateFormat.datePickerDate} dateFormat={DateFormat.datePickerDate} onChange={(date) => this.setState({
                                    receiptStartDate: date,
                                  })} />
                                </Grid>

                                <Grid item xs={12} md={5} className="mt-3 mt-md-0 ml-md-2">
                                  <DatePicker style={{ width: '100%' }} selected={receiptEndDate} placeholderText={DateFormat.datePickerDate} dateFormat={DateFormat.datePickerDate} onChange={(date) => this.setState({
                                    receiptEndDate: date,
                                  })} />
                                </Grid>
                              </Grid>
                          ...
                          <Grid container className="mt-4">
                            ...
                            <Grid item xs={7} md={8}>
                              <Grid container>
                                <Grid item xs={12} md={5}>
                                  <DatePicker style={{ width: '100%' }} selected={paymentStartDate} placeholderText={DateFormat.datePickerDate} dateFormat={DateFormat.datePickerDate} onChange={(date) => this.setState({
                                    paymentStartDate: date,
                                  })} />
                                </Grid>

                                <Grid item xs={12} md={5} className="mt-3 mt-md-0 ml-md-2">
                                  <DatePicker style={{ width: '100%' }} selected={paymentEndDate} placeholderText={DateFormat.datePickerDate} dateFormat={DateFormat.datePickerDate} onChange={(date) => this.setState({
                                    paymentEndDate: date,
                                  })} />
                                </Grid>
                              </Grid>
                          ...
                          <Grid container className="mt-4">
                            ...
                            <Grid item xs={7} md={8}>
                              <Grid container className="ml-2 ml-md-0">
                                ...
                                <Grid item xs={12} md={4} className="mt-3 mt-md-0 ml-md-2">
                                  <input type="number" placeholder="Min" className="form-control" value={this.state.instructedAmountMin} onChange={(e) => this.setState({
                                    instructedAmountMin: e.target.value,
                                  })} />
                                </Grid>
                                <Grid item xs={12} md={4} className="mt-3 mt-md-0 ml-md-2">
                                  <input type="number" placeholder="Max" className="form-control" value={this.state.instructedAmountMax} onChange={(e) => this.setState({
                          ...
                          <Grid container className="mt-4">
                            ...
                            <Grid item xs={7} md={8}>
                              <Grid container className="ml-2 ml-md-0">
                                ...
                                >
                                  <input type="number" placeholder="Min" className="form-control" value={this.state.paymentAmountMin} onChange={(e) => this.setState({
                                ...
                                <Grid
                                  ...
                                  className="mt-3 mt-md-0 ml-md-2"
                                >
                                  <input type="number" placeholder="Max" className="form-control" value={this.state.paymentAmountMax} onChange={(e) => this.setState({
                        ...
                        <Grid item xs={12} md={4} className="mt-3 mt-md-0">
                          <Grid container>
                            ...
                            <Grid item xs={7} className="ml-2 ml-md-0">
                              <input type="text" className="form-control" value={this.state.payerName} onChange={(e) => this.setState({ payerName: e.target.value })} />
                            </Grid>
                          </Grid>
                          ...
                          <Grid container className="mt-4">
                            ...
                            <Grid item xs={7} className="ml-2 ml-md-0">
                              <input type="text" className="form-control" value={this.state.collectionRef} onChange={(e) => this.setState({ collectionRef: e.target.value })} />
                            </Grid>
                          </Grid>
                          ...
                          <Grid container className="mt-4">
                            ...
                            <Grid item xs={7} className="ml-2 ml-md-0">
                              <input type="text" className="form-control" value={this.state.requestorTransactionId} onChange={(e) => this.setState({ requestorTransactionId: e.target.value })} />
                            </Grid>
                          </Grid>
                        </Grid>
                      </Grid>}
                      ...
                      <div className="transaction-status">
                        <div className="mb-2">
                          <label htmlFor="status" style={{ fontSize: '16px', fontWeight: '500' }}>Transaction Status</label>
                        </div>
                        <ul
                          style={{
                            display: "flex",
                            ...
                            <Grid container>
                              ...
                              >
                                ...
                                <div className="d-flex">
                                  <DatePicker style={{ width: '100%' }} selected={failedAttemptStartDate} placeholderText="From" dateFormat={DateFormat.datePickerDate} onChange={(date) =>
                                    this.setState({
                                  ...
                                  <label
                                    ...
                                    className="py-1"
                                  ></label>
                                  <DatePicker style={{ width: '100%' }} selected={failedAttemptEndDate} placeholderText="To" dateFormat={DateFormat.datePickerDate} onChange={(date) =>
                                    this.setState({
                              ...
                              >
                                ...
                                <div className="d-flex">
                                  <select className="form-control" value={this.state.instructedAmountCcy} onChange={(e) =>
                                    this.setState({
                                  ...
                                  <table className=" table-bordered w-auto mw-100 failure-attempts-table">
                                    ...
                                    <tbody>
                                      {failedTransactions.map((ft, index) => (
                                        <tr key={index}>
                                          <td> {moment(ft.creationDate).format(DateFormat.date)} <br /> {moment(ft.creationDate).format(DateFormat.time)}</td>
                                          <td style={{ width: '50px' }}>{ft.collectionReferenceNo}</td>
                                          <td>{ft.debtorEmailId}</td>
                                          <td><span className="pgStatus">{this.humanize(ft.pgStatus)}</span></td>
                                          <td>{ft.dueAmount}</td>
            ...
            <Box sx={{ width: '100%', marginTop: '2%' }}>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xl={6} lg={6} md={6} sm={6} xs={6} display="flex" alignContent="center" alignItems="center">
                  <Typography variant="body1" fontSize={17} style={{color: 'blue' }}>
                      Your Search Returned {totalPaymentsFound ? totalPaymentsFound : 0} Payments
                  </Typography>
                </Grid>
              </Grid>
              ...
              <Grid container>
                <Grid item xs={6.5} display="flex" justifyContent="end" alignItems="center" paddingTop={2}>
                ...
                <Grid item xs={5.5} display="flex" justifyContent="end" alignItems="center">
                  <ButtonPrimary size={"small"} variant="contained" onClick={this.downloadTransactions}
                    style={{ background: '#264d73', textTransform: 'capitalize' }}>
                    Download as CSV
                  </ButtonPrimary>
                </Grid>
              </Grid>
                        ...
                        <>
                          ...
                          <Grid item xs={6}>
                            <Typography
                              ...
                              onClick={() => { selectedPaymentConfirmationId !== null && selectedPaymentConfirmationId !== '' ? this.getPaymentDetails(selectedTransactionId) : '' }}
                    ...
                    <Grid container rowSpacing={1}>
                      ...
                      <Grid item xs={12}>
                        ...
                        <Typography gap={2} variant="body1" fontSize={17} style={{ color: 'rgb(106 158 222)', display: 'inline' }}>
                          ...
                          <IconButton aria-label="Duplicate"
                            onClick={() => { this.handleCopyClick(refundResponse.pgData.merchantTxnId) }}
                          >
                            <FileCopyOutlinedIcon style={{ color: 'rgb(106 158 222)' }} />
                          </IconButton>
                        </Typography>
                  ...
                  <Container maxWidth='sm'>
                    <Grid container rowSpacing={2} marginTop={2}>
                      ...
                      <Grid item xs={7}>
                        ...
                        <Typography>{refundResponse.cardBrand !== null ? refundResponse.cardBrand + " " + refundResponse.paymentMode : refundResponse.paymentMode}</Typography>
                      </Grid>
                      ...
                      <Grid item xs={7}>
                        <Typography>{refundResponse.refundAttemptTimestamp !== null ? moment(refundResponse.refundAttemptTimestamp).format(DateFormat.dateTime):''}</Typography>
                      </Grid>
                      ...
                      <Grid item xs={7}>
                        <Typography>{refundResponse.refundReason !== null ? refundResponse.refundReason : ''}</Typography>
                      </Grid>
                    </Grid>
                  </Container>
                </ConfirmDialog>
                ...
                <ConfirmDialog title="Warning" open={true} setOpen={true}>
                  <Container maxWidth="sm">
                    <Grid container rowSpacing={3}>
                      ...
                      <Grid item xs={7}>
                        <Typography fontSize={15} sx={{ color: 'rgb(106 158 222)', display: 'inline', mr: 1 }}>{refundResponse.pgData.merchantTxnId}</Typography>
                        <IconButton style={{ padding: '0px' }} onClick={() => this.handleCopyClick(refundResponse.pgData.merchantTxnId)} >
                          <FileCopyOutlinedIcon style={{ color: 'rgb(106 158 222)' }} />
                        </IconButton>
                      </Grid>
                      ...
                      <Grid item xs={7}>
                        <Typography fontSize={15} sx={{ display: 'inline', mr: 1 }}>{refundResponse.refundReason.errors[0].errorDescription}</Typography>
                      </Grid>
                      ...
                      <Grid item xs={6}>
                        <Typography fontSize={15}>{refundResponse.debtorName}</Typography>
                      </Grid>
                      ...
                      <Grid item xs={6}>
                        <Typography fontSize={15}>{refundResponse.debtorEmailId}</Typography>
                      </Grid>
                      ...
                      <Grid item xs={6}>
                        <Typography fontSize={15}>{refundResponse.cardBrand !== null ? refundResponse.cardBrand + " " + refundResponse.paymentMode : refundResponse.paymentMode}</Typography>
                      </Grid>
                      ...
                      <Grid item xs={6}>
                        <Typography fontSize={15}>{refundResponse.refundType === "F" ? "Full" : refundResponse.refundType === "P" ? "Partially" : "Error"}</Typography>
                      </Grid>
                      ...
                      <Grid item xs={6}>
                        <Typography fontSize={15}>{refundResponse.refundAttemptTimestamp !== null ? moment(refundResponse.refundAttemptTimestamp).format(DateFormat.dateTime) : ''}</Typography>
                      </Grid>
        ...
        >
          <Container maxWidth="sm">
            <Grid container rowSpacing={3}>
              ...
              <Grid item xs={6}>
                <Typography fontSize={15}>{paymentDetails.cardBrand + ' ' + paymentDetails.paymentMode}</Typography>
              </Grid>
              ...
              <>
                ...
                <Container maxWidth="sm">
                  <Grid container rowSpacing={2}>
                    ...
                    <Grid item xs={8} >
                      <Typography fontSize={15} >{item.paymentCurrency}{" "}{item.finalPaymentAmount}</Typography>
                    </Grid>
